...
<div>
    ...
    <div class="intro">
        <div class="container">
            <div class="v-intro">
                <div class="left">
                    <video id="videoPlayer" src="${sessionScope.video.videoUrl}" class="video-js vjs-default-skin" controls
                           width="627" height="280"
                           poster="${sessionScope.video.imageUrl}" data-setup="{}">
                    </video>
                </div>

                <div class="right">
                    <p class="right-title">${sessionScope.video.title}</p>
                    <div class="avatar">
                        <span style="background-image: url(${video.speaker.speakerImgUrl})"></span>
                        <p><b>讲师：${sessionScope.video.speaker.speakerName}</b><br><i>${sessionScope.video.speaker.speakerDesc}</i></p>
                    </div>
                    <p class="video-intro">
                        <span>本节内容：</span> ${sessionScope.video.detail}
                    </p>
                </div>
            </div>
            ...
            <div class="kcjs">
                ...
                <p class="content">${sessionScope.course.courseDesc}</p>
            </div>
    ...
    <div class="catalog">
        <div class="container">
            ...
            <c:forEach items="${sessionScope.course.videos}" var="video">
